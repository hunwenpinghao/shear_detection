...
- **鲁棒拟合算法**（`robust_curve_fit`）- **优化版 v2.0**（2025-10-14）：
...
**效果**：现在所有采样结果都严格按照帧ID间隔，保证文件名为 `frame_000000`, `frame_000100`, `frame_000200` 等。
